...
import static com.example.sendmessage.Constants.MSG_STARTCLIENT;
import static com.example.sendmessage.Constants.MSG_STARTSERVER;
...
public class QuizApp extends Application {
	...
	QuizActivity mHomeActivity = null;
	...
	public boolean isP2pEnabled() {
		...
		if(state != null)
		{
		Log.d(TAG,"values from preferences"+state.trim());
		}
		else
			Log.d(TAG,"values from preferences is null");
