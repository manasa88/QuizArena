...
public class DeviceDetailFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mApp = (QuizApp)getActivity().getApplication();
    }
        ...
        mContentView.findViewById(R.id.btn_start_client).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Log.d(TAG, "start_client button clicked, start quiz activity !");
                        ((QuizActivity)getActivity()).startQuizActivity(null);  // no init msg if started from button click.
                    }
                });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(QuizActivity.TAG, "Intent----------- " + uri);
    ...
    public static class FileServerAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                Log.d(QuizActivity.TAG, "Server: Socket opened");
                
                Socket client = serverSocket.accept();
                Log.d(QuizActivity.TAG, "Server: connection done");
                ...
                Log.d(QuizActivity.TAG, "server: copying files " + f.toString());
    ...
    public static boolean copyFile(InputStream inputStream, OutputStream out) {
        ...
        try {
            ...
            Log.d(QuizActivity.TAG, e.toString());
            return false;
        }
        return true;
    }
